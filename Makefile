...
kataribe:
	...
	. ~/env.sh && cat /tmp/last-access.log | kataribe -conf kataribe.toml > ~/kataribe-logs/$timestamp.log
...
bench:
	ssh bench -C "/home/isucon/private_isu.git/benchmarker/bin/benchmarker  -u /home/isucon/private_isu.git/benchmarker/userdata -t http://172.31.31.123"
